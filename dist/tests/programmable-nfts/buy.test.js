...
const getTestSetupV2_1 = __importDefault(require("tests/utils/getTestSetupV2"));
...
describe("buy Programmable NFT tests (placing bids/offers)", () => {
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        const setupResult = yield (0, getTestSetupV2_1.default)({
            auctionHouseConfig: {
            ...
            connection,
            programCreatorWallet: Wallets_1.WALLET_CREATOR,
            useProgrammableNft: true,
        });
        buyer = setupResult.buyers[0];
        buyer2 = setupResult.buyers[1];
        seller = setupResult.sellers[0];
        seller2 = setupResult.sellers[1];
        tokenMint = setupResult.tokenMint;
        tokenAccount = setupResult.tokenAccount;
        buyerTokenAccount = setupResult.buyerTokenAccount;
        auctionHouseSdk = setupResult.auctionHouseSdk;
        metadataData = setupResult.metadataData;
        // eslint-disable-next-line
        programmableNftMetadata = setupResult.programmableNftMetadata;
    }));
    // Skip as it takes too long to wait for finalized for each test, re-enable as needed
    it.each([SaleType_1.default.InstantSale, SaleType_1.default.Offer])(`executing buy with sale type %i should not set last bid price`, (saleType) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it.only("buy", () => __awaiter(void 0, void 0, void 0, function* () {
        // Seller lists
