...
function getTestSetupV2({ auctionHouseConfig, connection, numBuyers, numSellers, programCreatorWallet, tokenMintAddress, useProgrammableNft = false, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let programmableNftMetadata = null;
        let tokenAccount;
        if (useProgrammableNft) {
            const { metadataAccount, mint } = yield (0, createProgrammableNft_1.default)({
                connection,
                creator: seller,
                metadataCreators: [
            ...
            const [ata] = (0, formfunction_program_shared_1.findAtaPda)(seller.publicKey, tokenMint);
            tokenAccount = ata;
            (0, formfunction_program_shared_1.logIfDebug)("creating token account for buyer");
            buyerTokenAccount = yield (0, formfunction_program_shared_1.createTokenAccount)(connection, tokenMint, buyer);
        }
        else {
            if (tokenMint == null) {
            ...
            tokenAccount = yield (0, formfunction_program_shared_1.createTokenAccount)(connection, tokenMint, seller);
            (0, formfunction_program_shared_1.logIfDebug)("creating token account for buyer");
            buyerTokenAccount = yield (0, formfunction_program_shared_1.createTokenAccount)(connection, tokenMint, buyer);
            ...
            metadataData = (0, getTestMetadata_1.default)({ address: sellers[0].publicKey, share: 90, verified: true }, { address: sellers[1].publicKey, share: 10, verified: false });
            if (!metadataExists) {
...
exports.default = getTestSetupV2;
//# sourceMappingURL=getTestSetupV2.js.map